...
* `getUseLevel`: you can pass a function wich get used to determine the logger level. The first argument is the response. The second argument is the error object if it passed.
